...
let Collection = function () {
    ...
    let handleEntity = function (collection, child) {
        let $addLink = $('<a href="#" class="btn btn-light-success btn-sm add-child"><span><i class="fa fa-plus"></i><span>Agregar</span></span></a>');
    ...
    let addBlockFormDeleteLink = function($formLi) {
        let $removeFormA = $('<a href="#" class="btn btn-sm btn-light-danger btn-icon delete-child" style="position: absolute; top: 0; right: 0;"><i class="fa fa-times"></i></a>');
